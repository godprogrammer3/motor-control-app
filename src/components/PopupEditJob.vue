        ...
        <v-form v-model="valid" ref="form" lazy-validation>
          <v-card width="40vw" height="85vh" class="pa-2">
            <v-col align="center" justify="center">
              ...
              <v-row align="center" justify="center">
                <v-col>   
                  <span class="text-h4 indigo--text">ความกว้าง</span>
                   <v-text-field
                  ref="width"
                  :value="width"
                  suffix="ซม."
...
export default {
  ...
  mounted () {
    ...
    this.workDate = this.parseDateFromDB(this.job.work_date);
  },
  watch: {
    job(newValue, oldValue) {
      if(newValue.job_id){
        this.jobId = newValue.job_id;
      }
      if(newValue.width){
      ...
      if(newValue.work_date){
        this.workDate = this.parseDateFromDB(newValue.work_date);
      }
    }
  },
